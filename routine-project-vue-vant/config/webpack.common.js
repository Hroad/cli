...
const loadJSConfig=(()=>{
  return CompatibleConfig.allowBabel?[{loader:'babel-loader'}]:[];
})();

// Configure vue-loader
const loadVueConfig=(()=>{
  return CompatibleConfig.baseVUE? [{
    test: /\.vue$/,
    use: [{ loader: 'vue-loader' }],
    include: [helpers.root('src/views'), helpers.root('src/common-ui')]
  }] : [];
})();
...
const loadCssConfig=((isProd)=>{
  ...
  if(isProd){
    ...
    if(CompatibleConfig.baseVUE) loaderArr.push('vue-style-loader');
  } 
  loaderArr=[
    ...loaderArr,
    'css-loader',
...
module.exports = function (options) {
  ...
  return {
    ...
    resolve: {
      ...
      alias: Object.assign({}, {
        'vue': helpers.root('node_modules/vue/dist/vue.js'),
        ...
        '@common-ui': helpers.root('src/common-ui'),
        '@': helpers.root('src'),
        '@root': helpers.root('./'),
    ...
    module: {
      rules: [
        ...
        },
        {
          ...
          include: [helpers.root('src'),helpers.root('node_modules/vant')]
        },
        {
